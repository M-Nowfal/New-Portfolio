...
const Skills = () => {
  ...
  return (
    <section className="text-center pb-20 pt-10 px-4 sm:px-6 lg:px-8" id="skills">
      ...
      <div className="max-w-6xl mx-auto">
        {skillCategories.map(category => (
          <div key={category.name} className="mb-16">
            <h2 className="text-2xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-500">
              {category.name}
            </h2>
                ...
                >
                  ...
                  <figure
                    className={`
                      ...
                      items-center justify-center group hover:-translate-y-1 cursor-pointer scale-80 md:scale-100
                    `}
                    role="button"
      ...
      <div className="mt-20">
        <h2 className="text-2xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-500">
          Also Familiar With
        </h2>
