          ...
          <DropdownMenuContent align="start" className="mt-4 ms-4">
            {navLinks.map(link => (
              <DropdownMenuItem key={link.title}>
                <Link href={link.link} className="w-full ps-3 pe-10 hover:translate-x-2 my-1 text-lg hover:text-orange-600 font-semibold transition-all duration-200 flex items-center gap-3">
